...
router.register("Adresse_fournisseur", Adress_distributorViewset)
router.register("category_semences", SeedCategoryViewset)
router.register("variete", VarietyViewset)
router.register("commande", CommandeViewset)
router.register("Cotations_semences", RateSeedViewset)
